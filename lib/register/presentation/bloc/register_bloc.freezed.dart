...
class _$_RegisterButtonPressed implements _RegisterButtonPressed {
  const _$_RegisterButtonPressed({this.name, this.email, this.password});
  ...
  @override
  String toString() {
    return 'RegisterEvent.registerButtonPressed(name: $name, email: $email, password: $password)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return registerButtonPressed(name, email, password);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return registerButtonPressed?.call(name, email, password);
  }
...
abstract class _RegisterButtonPressed implements RegisterEvent {
  const factory _RegisterButtonPressed(
      {final String? name,
      final String? email,
      final String? password}) = _$_RegisterButtonPressed;
...
mixin _$RegisterState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(RegisterResponse registerResponse) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(RegisterResponse registerResponse)? success,
...
class __$$_SuccessCopyWithImpl<$Res>
  ...
  $RegisterResponseCopyWith<$Res> get registerResponse {
    return $RegisterResponseCopyWith<$Res>(_value.registerResponse, (value) {
      return _then(_value.copyWith(registerResponse: value));
    });
  }
}
...
class _$_Success implements _Success {
  const _$_Success(this.registerResponse);
...
abstract class _Success implements RegisterState {
  const factory _Success(final RegisterResponse registerResponse) = _$_Success;

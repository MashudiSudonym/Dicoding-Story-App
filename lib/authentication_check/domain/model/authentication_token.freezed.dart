...
abstract class $AuthenticationTokenCopyWith<$Res> {
  factory $AuthenticationTokenCopyWith(
      ...
      _$AuthenticationTokenCopyWithImpl<$Res, AuthenticationToken>;
  @useResult
  $Res call({String token});
}

/// @nodoc
class _$AuthenticationTokenCopyWithImpl<$Res, $Val extends AuthenticationToken>
...
class __$$_AuthenticationTokenCopyWithImpl<$Res>
    extends _$AuthenticationTokenCopyWithImpl<$Res, _$_AuthenticationToken>
...
class _$_AuthenticationToken implements _AuthenticationToken {
  const _$_AuthenticationToken({required this.token});
...
abstract class _AuthenticationToken implements AuthenticationToken {
  const factory _AuthenticationToken({required final String token}) =
